...
def analyze_sensor_noise(imu_data, usbl_data, depth_data):
    """
    Analizza i dati dei sensori per stimare le matrici di covarianza
    """
    print("\n" + "="*70)
    print("ANALISI AUTOMATICA RUMORE SENSORI")
    print("="*70)
...
if __name__ == "__main__":
    ...
    sensor_noise = analyze_sensor_noise(imu_data, usbl_data, depth_data)
